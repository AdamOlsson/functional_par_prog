...
let reduce_by_index2 'a [n] [m] (dest: *[m]a) (f: a -> a -> a) (ne: a) (is: [n]i32) (as: [n]a) : *[m]a =
    let key     = (\(k,_) -> k)
    ...
    let red     = segreduce f ne (zip d flags)
    in loop (dest) for i < m do
        dest with [i] = red[i]


let main [n] (k:[n]i32) (d:[n]i32) (s: i32)= reduce_by_index2 (0..<s) (+) 0 k d
