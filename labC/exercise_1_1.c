...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    struct futhark_i32_1d *read_value_4501;
    int64_t read_shape_4502[1];
    int32_t *read_arr_4503 = NULL;
    
    errno = 0;
    if (read_array(&i32_info, (void **) &read_arr_4503, read_shape_4502, 1) !=
        0)
        futhark_panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 0,
                      "[]", i32_info.type_name, strerror(errno));
    
    struct futhark_i32_1d *read_value_4504;
    int64_t read_shape_4505[1];
    int32_t *read_arr_4506 = NULL;
    
    errno = 0;
    if (read_array(&i32_info, (void **) &read_arr_4506, read_shape_4505, 1) !=
        0)
        futhark_panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 1,
                      "[]", i32_info.type_name, strerror(errno));
    if (end_of_input() != 0)
    ...
    if (perform_warmup) {
        ...
        assert((read_value_4501 = futhark_new_i32_1d(ctx, read_arr_4503,
                                                     read_shape_4502[0])) != 0);
        assert((read_value_4504 = futhark_new_i32_1d(ctx, read_arr_4506,
                                                     read_shape_4505[0])) != 0);
        ...
        r = futhark_entry_main(ctx, &result_4507, read_value_4501,
                               read_value_4504);
        if (r != 0)
            futhark_panic(1, "%s", futhark_context_get_error(ctx));
        if (futhark_context_sync(ctx) != 0)
        ...
        assert(futhark_free_i32_1d(ctx, read_value_4501) == 0);
        assert(futhark_free_i32_1d(ctx, read_value_4504) == 0);
        ;
    }
    time_runs = 1;
    // Proper run.
    ...
    write_scalar(stdout, binary_output, &i32_info, &result_4507);
    printf("\n");
    ;
}
...
static int futrts_main(struct futhark_context *ctx,
                       int32_t *out_scalar_out_4500,
                       struct memblock xs_mem_4496, struct memblock ys_mem_4497,
                       int32_t implz2081U_4479, int32_t implz2081U_4480);
...
static int futrts_main(struct futhark_context *ctx,
                       ...
                       int32_t implz2081U_4479, int32_t implz2081U_4480)
{
    int32_t scalar_out_4498;
    bool dim_match_4483 = implz2081U_4479 == implz2081U_4480;
    bool empty_or_match_cert_4484;
    
    if (!dim_match_4483) {
        ctx->error = msgprintf("Error: %s\n\nBacktrace:\n%s",
                               "function arguments of wrong shape",
                               "-> #0  exercise_1_1.fut:15:1-16:15\n");
        return 1;
    }
    
    int32_t res_4486;
    int32_t redout_4494 = 0;
    
    for (int32_t i_4495 = 0; i_4495 < implz2081U_4479; i_4495++) {
        int32_t x_4490 = ((int32_t *) xs_mem_4496.mem)[i_4495];
        int32_t x_4491 = ((int32_t *) ys_mem_4497.mem)[i_4495];
        int32_t res_4492 = sub32(x_4490, x_4491);
        int32_t res_4493 = abs(res_4492);
        int32_t res_4489 = smax32(res_4493, redout_4494);
        int32_t redout_tmp_4499 = res_4489;
        
        redout_4494 = redout_tmp_4499;
    }
    res_4486 = redout_4494;
    scalar_out_4498 = res_4486;
    *out_scalar_out_4500 = scalar_out_4498;
    return 0;
}
struct futhark_i32_1d {
    struct memblock mem;
...
int futhark_entry_main(struct futhark_context *ctx, int32_t *out0, const
                       ...
                       struct futhark_i32_1d *in1)
{
    struct memblock xs_mem_4496;
    
    xs_mem_4496.references = NULL;
    
    struct memblock ys_mem_4497;
    
    ys_mem_4497.references = NULL;
    
    int32_t implz2081U_4479;
    int32_t implz2081U_4480;
    int32_t scalar_out_4498;
    
    lock_lock(&ctx->lock);
    xs_mem_4496 = in0->mem;
    implz2081U_4479 = in0->shape[0];
    ys_mem_4497 = in1->mem;
    implz2081U_4480 = in1->shape[0];
    
    int ret = futrts_main(ctx, &scalar_out_4498, xs_mem_4496, ys_mem_4497,
                          implz2081U_4479, implz2081U_4480);
    
    if (ret == 0) {
        *out0 = scalar_out_4498;
    }
    lock_unlock(&ctx->lock);
    return ret;
}
